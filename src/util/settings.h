...
extern int G_EnhanceUpLevel;
extern int G_EnhanceShowLevel;
extern float G_EnhanceThreshold; // reject targets, smaller in 3D(0.4), bigger in 2D(0.33)
extern int G_IsSaveFlow;
extern float G_StableRange;

extern float G_lastkeyframeTimeStamp;
extern float G_CurkeyframeTimeStamp;
...
// #define patternNum 5
// #define patternP staticPattern[1]


#define patternPadding 2
#define DisparityEdgeG 5

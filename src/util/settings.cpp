...
{
// Enhance....
int G_EnhanceUpLevel=10000;
int G_EnhanceShowLevel=10000;
float G_EnhanceThreshold=0.5; // reject targets, smaller in 3D(0.4), bigger in 2D(0.33)
int G_IsSaveFlow=0;
float G_StableRange=0.8;

float G_lastkeyframeTimeStamp = -1;
float G_CurkeyframeTimeStamp = -1;


// int pyrLevelsUsed = PYR_LEVELS;//PYR_LEVELS;
